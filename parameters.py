'''
This file contains all parameters the user needs to set to run the Python program
foxmask.py.
'''



# Location of the folder containing photos to analyze (do not forget the final /)
# Can be one folder or a list of folders (but no embedded folders)

imagesDir = ['/media/sf_vagrant/reconyx/Fox024-2008-Cam1-test/',
	     '/media/sf_vagrant/reconyx/Fox024-2008-Cam2-test/']



# Location of the folder to store results (do not forget the final /)
...
# One file will be created for each input folder (and for each value of minsize, see below)

ouname = ['Fox024-2008-Cam1', 'Fox024-2008-Cam2']
...
minsize = [5,   10,   15,   20,   25,   30,   35,   40,   45,   50,   55,
