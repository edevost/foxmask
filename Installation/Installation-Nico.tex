...
\item This modules come with a standard Python installation. You can just call it directly with import.
 ...
 \begin{description}
\item [import os] Used to manipulate path operations with os.path. This is the recommended way for platform independent path manipulations. %This module comes with standard Python installation.
